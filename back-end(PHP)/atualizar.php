        ...
        <div class="modal-content">
         ...
         <form method="post"   id="formUpdate">
                    ...
                    <div class="form-group">
                        <input type="hidden"   class="form-control" id="id" name="idUsuario"  value="';echo $_POST['idUsuario']; echo'" required="required">
                   ...
                   <div class="form-group">
                       <input type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF" maxlength="11" required="required">
                   ...
                   <button class="btn btn-warning btnAtualizar" id="Att" type="submit" >Atualizar</button>
